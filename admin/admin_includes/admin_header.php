    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          <li class="active">
            <a href="index.php"><i class="glyphicon glyphicon-dashboard"></i> Admin Dashboard</a>
          </li>
          <li>
            <a href="add-product.php"><i class="glyphicon glyphicon-plus-sign"></i> Add Product</a>
          </li>
          <li>
